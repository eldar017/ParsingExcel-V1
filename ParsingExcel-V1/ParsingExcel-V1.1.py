    ...
    if "base64buffer" in excel_dict:
        if str(file_extension).split(".")[1] == 'xls':
            ...
            try:
                ...
                f1 = '/opt/ExcelBackup/output-xls-' + str(uuid.uuid4()) + '.xlsx'
                ...
                if match2.value == None:
                    ...
                    for j in range(1, 4):
                        for i in range(1, mr):
                            if ws.cell(row=i, column=1).value is None:
                                ...
                                continue
                    f = '/opt/ExcelBackup/output-otsar-hahayal-' + str(uuid.uuid4()) + '.xlsx'
                    wbb.save(filename=f)
                    ...
                    if match.value == None:
                        ...
                        for j in range(1, 4):
                            for i in range(1, mr):
                                if ws.cell(row=i, column=1).value is None:
                                    ...
                                    continue
                        f = '/opt/ExcelBackup/output-isracard-' + str(uuid.uuid4()) + '.xlsx'
                        wbb.save(filename=f)
                        ...
                        f = '/opt/ExcelBackup/output-visa-' + str(uuid.uuid4()) + '.xlsx'
                        wbb.save(filename=f)
                        ...
                        message_error_format = {"userId": userId, "errtype": error_type, "origin": "Parser", "curr_date": curr_date,
                                                "fileName": fileName}
        ...
        if str(file_extension).split(".")[1] == 'xlsx':
            ...
            try:
                ...
                f2 = '/opt/ExcelBackup/output-xlsx-' + str(uuid.uuid4()) + '.xlsx'
